...
model = Sequential()
model.add(Conv2D(256, kernel_size=(9, 9),
                 activation='relu',
...
print("Training took a total of ", time.time()-start, "s for ", epochs, " epochs.")
start2 = time.time()
score = model.evaluate(x_test, y_test, verbose=0)
print("Testing took a total of ", time.time()-start2, "s.")
