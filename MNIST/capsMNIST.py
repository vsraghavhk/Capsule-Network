...
mnist = input_data.read_data_sets("I:/Course Work/CSCE636 - Neural Networks/Project/Capsule-Network/MNIST/data/")
print("MNIST data extracted.")

n_epochs = 250
checkpoint_path = "checkpoints/my_capsule_network"
